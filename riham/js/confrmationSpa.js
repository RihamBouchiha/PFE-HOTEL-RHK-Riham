fetch('http://localhost:5502/derniere_reservation_spa')
  ...
  .then(data => {
    ...
    messageRemerciement.textContent = `Merci ${data.prenom} ${data.nom} pour votre réservation! Nous avons hâte de vous accueillir à RHK Spa.`;
  })
  ...
  document.getElementById("downloadButton").addEventListener("click", function() {
    ...
    link.href = url;
    link.download = "Votre réservation de spa.html";
